...
namespace GameEngine {
	...
	{
		static const uint32_t MaxQuads = 10000;			    // 批处理一次最多可绘制的四边形
		static const uint32_t MaxVertices = MaxQuads * 4;	// 最多支持的顶点数量
		static const uint32_t MaxIndices = MaxQuads * 6;	// 最多支持的索引数量
